...
public class BrokerController {
    ...
    public ResponseEntity<CustomResponse> createQuotationsResponse(
        ...
        List<String> portList = Arrays.asList("8080", "8081", "8082");

//      Retrieve the specific URLs
        for (String port : portList) {
            try {
                RestTemplate template = new RestTemplate();
                ResponseEntity<ClientInfo> response = template.postForEntity("http://localhost:" + port + "/quotations", info, ClientInfo.class);
